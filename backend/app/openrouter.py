...
# SECURITY: Reject non-HTTPS base URLs at import time to prevent API key
# exfiltration over plaintext HTTP.
if config.OPENROUTER_BASE_URL and not config.OPENROUTER_BASE_URL.startswith('https://'):
    ...
    *,
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "HTTP-Referer": os.environ.get("QAQC_OPENROUTER_REFERER", "https://golivio.com/qa-qc"),
    ...
    # Retry logic: exponential backoff for 429/503/502 (3 attempts, 1s/2s/4s delays).
    max_attempts = 3
    last_exc = None
    for attempt in range(max_attempts):
        try:
            ...
            if exc.code in (429, 503, 502) and attempt < max_attempts - 1:
