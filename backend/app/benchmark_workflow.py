...
import os as _os
VECTOR_R_MIN = float(_os.environ.get("QAQC_VECTOR_R_MIN", "6.0"))
VECTOR_R_MAX = float(_os.environ.get("QAQC_VECTOR_R_MAX", "30.0"))
VECTOR_TEXT_NEAR_PT = float(_os.environ.get("QAQC_VECTOR_TEXT_NEAR_PT", "60.0"))
...
STAMP_TOLERANCE_PT = float(_os.environ.get("QAQC_STAMP_TOLERANCE_PT", "3.0"))
